...
export default {
  ...
  watch: {
    scrollY(newVal) {
        ...
        this.$refs.layer.style['transform'] = `translate3d(0,${translateY}px,0)` // 另一种写法
        let zIndex = 0
        let scale = 1
        let blur = 0
        ...
        if (newVal < this.minTransalteY) {
          ...
          this.$refs.playBtn.style.display = '' // 就是和css里不写display是一样的
        }
        this.$refs.bgImage.style.zIndex = zIndex  // zIndex的格式
